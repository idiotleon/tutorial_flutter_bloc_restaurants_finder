...
import 'package:tutorial_flutter_bloc_restaurant_finder/ui/container_image.dart';
...
class RestaurantDetailsScreen extends StatelessWidget {
  ...
  Widget _buildBanner() {
    return ImageContainer(height: 200, url: restaurant.imageUrl);
  }
  ...
  Widget _buildFavoriteButton1(BuildContext context) {
    final bloc = BloCProvider.of<FavoriteBloC>(context);
    return StreamBuilder<List<Restaurant>>(
      stream: bloc.favoritesStream,
      initialData: bloc.favorites,
